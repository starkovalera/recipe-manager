(function () {
  ...
  const media = [
    { title: 'Finished traybake', origin: 'Instagram video frame', author: 'Marta Cooks', current: true },
    { title: 'Aubergine browning reference', origin: 'Instagram video frame', author: 'Marta Cooks' },
    { title: 'Tahini consistency', origin: 'Imported caption image', author: 'Marta Cooks' },
    { title: 'Packaging photo', origin: 'Ignored imported image', author: 'Unknown' }
  ];
  const importInfo = {
    flags: [
      { title: 'Cooking time conflicts', detail: 'Caption says 35 minutes; transcript says 45 minutes.' },
      { title: 'Quantity uncertain', detail: 'Smoked paprika was extracted as 1–2 tbsp.' },
      { title: 'One image ignored', detail: 'A packaging photo did not contribute recipe information.' }
    ],
    used: ['Instagram video transcript', 'Caption text', 'Three cooking frames'],
    ignored: ['Packaging photo', 'Profile avatar'],
    deleted: ['Duplicate low-resolution frame — restorable'],
    sourceUrl: 'instagram.com/reel/example-traybake',
    provenance: 'Title from caption; ingredient quantities reconciled against transcript and frames.',
    debug: 'resource-role=primary-video · extraction-pass=recipe-v3 · confidence=0.82'
  };
  const normalRecipe = {
  ...
  function scenario(recipe, overrides) {
    return Object.assign({ state: 'ready', recipe, importInfo, media, mediaAvailable: true }, overrides || {});
  }
  window.prototypeScenarios = {
    ...
    }), { importInfo: null, media: [], mediaAvailable: false }),
