    ...
    groups: [
      {
        ...
        children: [
          ...
          { id: 'cover-frame', type: 'Image', label: 'Finished traybake', status: 'Used', currentCover: true },
          { id: 'cooking-frame', type: 'Image', label: 'Aubergine browning reference', status: 'Used' },
          { id: 'package-frame', type: 'Image', label: 'Packaging photo', status: 'Ignored' },
          { id: 'profile-frame', type: 'Image', label: 'Profile avatar', status: 'Ignored' },
          { id: 'caption-text', type: 'Text', label: 'Caption text', status: 'Used' }
        ]
      },
      {
        id: 'uploaded-image', type: 'Image', label: 'Uploaded cookbook page', detail: 'page-42.jpg', status: 'Used', children: []
      },
      {
