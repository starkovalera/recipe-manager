...
function renderBasics() {
  return `<div class="section-panel basics-form" id="basics-panel">
    <div class="basics-grid">
      <label class="full-width">Recipe title<input name="title" value="Smoky Tomato & Butter Bean Stew"></label>
      <label>Source<select name="source"><option>Manual</option><option selected>Instagram</option><option>Threads</option><option>TikTok</option><option>Other</option></select></label>
      <label>Author<input name="author" value="Marta Cooks"></label>
      <label>Cooking time<input name="time" value="45 min"></label>
      <label>Servings<input name="servings" inputmode="decimal" value="4"></label>
      <label>Difficulty<select name="difficulty"><option>Not set</option><option>Easy</option><option selected>Moderate</option><option>Hard</option></select></label>
      <label>Personal rating<select name="rating"><option>Not rated</option><option>1 out of 5</option><option>2 out of 5</option><option>3 out of 5</option><option selected>4 out of 5</option><option>5 out of 5</option></select></label>
    </div>
  </div>`;
}
...
const sections = [
  ['basics', 'Basics', '7 fields', renderBasics],
...
function markRecipeDirty(event) {
...
appRoot.addEventListener('input', markRecipeDirty);
appRoot.addEventListener('change', markRecipeDirty);
