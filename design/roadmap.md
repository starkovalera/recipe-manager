...
| [#90 — Build the Recipe Detail Core Pen map](https://github.com/starkovalera/recipe-manager/issues/90) | Agent work delivered in [PR #100](https://github.com/starkovalera/recipe-manager/pull/100); `ready-for-human` while the owner Save As/fresh-open checkpoint remains pending |
...
| `[DESIGN][SHARED]` Design Operations #88–#96 | Core-map owner checkpoint and controlled regeneration join | #95 completed the fork checkpoint in [PR #98](https://github.com/starkovalera/recipe-manager/pull/98); #91 delivered the roadmap/tracker correction in [PR #99](https://github.com/starkovalera/recipe-manager/pull/99); #90 agent work landed in [PR #100](https://github.com/starkovalera/recipe-manager/pull/100) and now awaits owner persistence/review, then #96 joins the corrected source with the Core map; #92 owns the cockpit and #94 the measured remaining-domain rollout |
