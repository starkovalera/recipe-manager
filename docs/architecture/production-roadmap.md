...
| `[DEV][INFRA] Inventory P12 deployables and write the artifact matrix` | In progress | The [P12 artifact matrix](../specs/2026-08-14-p12-production-artifact-matrix.md) records six image artifacts, compatibility triggers, rollback identity, and child issues #41–#47; implementation remains open |
