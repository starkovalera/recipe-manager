...
Updated: 2026-08-21
Status: local baseline, P1-P10, P11 hardening, and P12 complete; cross-artifact CI #47 is complete/delivered in merged PR #87
...
| P12 production Docker artifacts | Complete; #41–#46 deliver the six images and #47 is complete/delivered in merged PR #87 | [#47](https://github.com/starkovalera/recipe-manager/issues/47) closes P12 through [PR #87](https://github.com/starkovalera/recipe-manager/pull/87) with six-image builds, deterministic health/invocation checks, full-SHA/digest manifests, and pinned vulnerability/secret scanning; the artifact runbooks retain the child delivery links |
...
Status: P1-P10, P11, and P12 complete; cross-artifact CI child #47 is complete/delivered in merged PR #87.
...
flowchart TD
  ...
  p12Shared --> p12Artifacts["✓ [DEV][INFRA] FastAPI/KrakenD #42 complete in PR #70; ✓ embedding #44 delivered in PR #83; ✓ maintenance #45 delivered in PR #84; ✓ import #43 delivered in PR #81; ✓ account-deletion #46 delivered in PR #85"]
  p12Artifacts --> p12Ci["✓ [DEV][INFRA] Cross-artifact CI (#47 complete/delivered in merged PR #87)"]
...
- P12 import Lambda child #43 is complete/delivered in PR #81; embedding child #44 is
  complete/delivered in PR #83; maintenance Lambda #45 is delivered in
  PR #84; account-deletion artifact #46 is complete/delivered in
  PR #85; FastAPI/KrakenD child #42 is complete in PR #70; cross-artifact CI
  child #47 is complete/delivered in draft [PR #87](https://github.com/starkovalera/recipe-manager/pull/87);
...
| P12 artifact implementation children | Complete; #41–#46 delivered the artifact seam and six images, and #47 is complete/delivered in merged PR #87 | [#47](https://github.com/starkovalera/recipe-manager/issues/47) verifies every artifact after #43 and #46 closed in [PR #87](https://github.com/starkovalera/recipe-manager/pull/87) and completes the P12 cross-artifact contract |
