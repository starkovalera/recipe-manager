...
Updated: 2026-08-19
Status: local baseline, P1-P10, and P11 hardening complete; P12 shared packaging #41 and FastAPI/KrakenD artifact child #42 complete in PR #70; embedding Lambda #44 complete/delivered in draft PR #83; maintenance Lambda #45 delivered in draft PR #84; import Lambda #43 complete/delivered in PR #81; account-deletion artifact #46 complete/delivered in draft PR #85; cross-artifact CI #47 remains blocked by #43 and #46 until those issues close
...
| P12 production Docker artifacts | Shared packaging #41 and FastAPI/KrakenD #42 complete in PR #70; embedding Lambda #44 complete/delivered in draft PR #83; maintenance Lambda #45 delivered in draft PR #84; import Lambda #43 complete/delivered in PR #81; account-deletion #46 complete/delivered in draft PR #85; #47 blocked by #43 and #46 until those issues close | [#41](https://github.com/starkovalera/recipe-manager/issues/41) delivered the digest-pinned, frozen-dependency Docker seam in merged [PR #68](https://github.com/starkovalera/recipe-manager/pull/68); [#42](https://github.com/starkovalera/recipe-manager/issues/42) delivers the API/gateway host unit and controlled migration boundary in [PR #70](https://github.com/starkovalera/recipe-manager/pull/70), which closes it on merge; [#43](https://github.com/starkovalera/recipe-manager/issues/43) delivers the import Lambda image in [PR #81](https://github.com/starkovalera/recipe-manager/pull/81), which closes it on merge; [#44](https://github.com/starkovalera/recipe-manager/issues/44) delivers the embedding Lambda image in draft [PR #83](https://github.com/starkovalera/recipe-manager/pull/83), which closes it on merge; [#45](https://github.com/starkovalera/recipe-manager/issues/45) delivers the maintenance Lambda image in draft [PR #84](https://github.com/starkovalera/recipe-manager/pull/84), which closes it on merge; [#46](https://github.com/starkovalera/recipe-manager/issues/46) delivers the account-deletion image in draft [PR #85](https://github.com/starkovalera/recipe-manager/pull/85), which closes it on merge; cross-artifact CI is [#47](https://github.com/starkovalera/recipe-manager/issues/47) |
...
Status: P1-P10 and P11 complete; P12 shared packaging children #41 and #42 are complete in PRs #68 and #70, embedding child #44 is complete/delivered in draft PR #83, maintenance child #45 is delivered in draft PR #84, import Lambda #43 is complete/delivered in PR #81, account-deletion child #46 is complete/delivered in draft PR #85, and cross-artifact CI child #47 remains blocked only by #43 and #46 until those issues close.
...
flowchart TD
  ...
  p12Shared --> p12Artifacts["✓ [DEV][INFRA] FastAPI/KrakenD #42 complete in PR #70; ✓ embedding #44 delivered in draft PR #83; ✓ maintenance #45 delivered in draft PR #84; ✓ import #43 delivered in PR #81; ✓ account-deletion #46 delivered in draft PR #85"]
...
- P12 import Lambda child #43 is complete/delivered in PR #81; embedding child #44 is
  complete/delivered in draft PR #83; maintenance Lambda #45 is delivered in
  draft PR #84; account-deletion artifact #46 is complete/delivered in draft
  PR #85; FastAPI/KrakenD child #42 is complete in PR #70; cross-artifact CI
  child #47 remains blocked by #43 and #46 until those issues close;
...
| P12 artifact implementation children | #41 and #42 complete in PRs #68 and #70; #43 complete/delivered in PR #81; #44 complete/delivered in draft PR #83; #45 delivered in draft PR #84; #46 complete/delivered in draft PR #85; #47 blocked by #43 and #46 until those issues close | [#41](https://github.com/starkovalera/recipe-manager/issues/41) delivered the shared packaging seam in merged [PR #68](https://github.com/starkovalera/recipe-manager/pull/68); [#42](https://github.com/starkovalera/recipe-manager/issues/42) consumes it for the private API/public gateway host unit in [PR #70](https://github.com/starkovalera/recipe-manager/pull/70), which closes it on merge; [#43](https://github.com/starkovalera/recipe-manager/issues/43) delivers the import Lambda artifact in [PR #81](https://github.com/starkovalera/recipe-manager/pull/81), which closes it on merge; [#44](https://github.com/starkovalera/recipe-manager/issues/44) delivers the embedding Lambda artifact in draft [PR #83](https://github.com/starkovalera/recipe-manager/pull/83), which closes it on merge; [#45](https://github.com/starkovalera/recipe-manager/issues/45) delivers the maintenance Lambda artifact in draft [PR #84](https://github.com/starkovalera/recipe-manager/pull/84), which closes it on merge; [#46](https://github.com/starkovalera/recipe-manager/issues/46) delivers the account-deletion artifact in draft [PR #85](https://github.com/starkovalera/recipe-manager/pull/85), which closes it on merge; [#47](https://github.com/starkovalera/recipe-manager/issues/47) verifies the cross-artifact contract after #43 and #46 close |
