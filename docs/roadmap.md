...
Known stale tracker/roadmap state is visible as `verification_needed` in the
completed First map. Issue #91 owns reconciliation so the same change becomes
the controlled regeneration proof in #96.
